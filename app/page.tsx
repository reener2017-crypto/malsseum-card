...
const TEMPLATE_POOLS = [
  {
    label: "경건",
    overlayAlpha: 0.52,
    seeds: [10, 110, 210, 310, 410, 510, 610, 710, 810, 910, 15, 115, 215, 315, 415],
  },
  {
    label: "밝음",
    overlayAlpha: 0.35,
    seeds: [20, 120, 220, 320, 420, 520, 620, 720, 820, 920, 25, 125, 225, 325, 425],
  },
  {
    label: "따뜻함",
    overlayAlpha: 0.38,
    seeds: [30, 130, 230, 330, 430, 530, 630, 730, 830, 930, 35, 135, 235, 335, 435],
  },
  {
    label: "자연",
    overlayAlpha: 0.42,
    seeds: [40, 140, 240, 340, 440, 540, 640, 740, 840, 940, 45, 145, 245, 345, 445],
  },
];
